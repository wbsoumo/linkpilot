<?php
// backend/install.php
// A self-contained installer script to set up database tables.

require_once __DIR__ . '/config.php';

echo "<h2>LinkPilot AI - Database Table Installer</h2>";
echo "<p>Connecting to database host: <strong>" . DB_HOST . "</strong>, database name: <strong>" . DB_NAME . "</strong>...</p>";
...
try {
    ...
    echo "<p style='color:red; font-weight:bold;'>[ERROR] Database Table Setup Failed: " . $e->getMessage() . "</p>";
}
