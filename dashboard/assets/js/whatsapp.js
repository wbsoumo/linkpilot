    ...
    checkWaConnectionAndRender('templates', container, async (contentArea) => {
        try {
            ...
            contentArea.innerHTML = `
                <div class="space-y-6">
                    <!-- Header Bar -->
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs animate-fade-in">
                        <div>
                            <h2 class="text-base font-extrabold text-slate-850 tracking-tight">Approved Meta Message Templates</h2>
                            <p class="text-xs text-slate-500 font-medium mt-0.5">Templates synced from your Facebook WABA console</p>
                        </div>
                        <div class="flex items-center space-x-2.5">
                            <button onclick="triggerTemplatesSync()" id="sync-tpl-btn" class="flex items-center space-x-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-extrabold transition shadow-sm shrink-0" style="color: #ffffff !important;">
                        ...
                        <div class="lg:col-span-4 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col items-center">
                            ...
                            <div class="phone-simulator">
                                ...
                                <div class="phone-screen">
                                    ...
                                    <div class="phone-header">
                                        <div class="flex items-center space-x-2 flex-grow">
                                            ...
                                            <div class="text-left">
                                                ...
                                                <p class="text-[9px] text-[#54656f] font-semibold leading-none mt-0.5">online</p>
                                            </div>
                                        </div>
                                    ...
                                    <!-- Messages Body -->
                                    <div class="chat-messages flex-grow overflow-y-auto p-3.5 flex flex-col gap-2" id="sim-tpl-messages-body">
                                        <div class="bubble incoming" style="max-width: 90%;">
                                            <div class="bubble-text w-full" id="mock-bubble-text">
                                    ...
                                    <div class="p-2 bg-[#f0f2f5] flex items-center space-x-2 shrink-0 border-t border-slate-200">
                                        <div class="flex-grow bg-white rounded-full px-3 py-1.5 flex items-center space-x-2 shadow-2xs border border-slate-100">
                                            ...
                                            <span class="flex-grow text-[10px] text-slate-400 select-none">Type a message</span>
                                        ...
                                        <div class="h-7 w-7 bg-[#00a884] text-white rounded-full flex items-center justify-center shrink-0 transition shadow-sm">
