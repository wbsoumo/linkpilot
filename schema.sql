...
-- 13. Payment Provider Settings (Razorpay)
...
-- 15. User Email Credits
CREATE TABLE IF NOT EXISTS `user_email_credits` (
    `id` INT AUTO_INCREMENT PRIMARY KEY,
    `user_id` INT UNIQUE NOT NULL,
...
-- 19. Email Search History
CREATE TABLE IF NOT EXISTS `email_search_history` (
    `id` INT AUTO_INCREMENT PRIMARY KEY,
    `user_id` INT NOT NULL,
    `name` VARCHAR(255) DEFAULT NULL,
